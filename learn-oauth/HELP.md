...
* The original package name 'com.ashmeet.learn-oauth' is invalid and this project uses 'com.ashmeet.learnoauth' instead.
...
* [OAuth2 Client](https://docs.spring.io/spring-boot/docs/3.0.10/reference/htmlsingle/index.html#web.security.oauth2.client)
